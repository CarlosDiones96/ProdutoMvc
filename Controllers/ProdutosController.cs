...
namespace ProdutoMvc.Controllers
{
    ...
    {
        private readonly ProdutoMvcContext _context;

        public ProdutosController(ProdutoMvcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Produto != null ? 
                          ...
                          Problem("Entity set 'ProdutoMvcContext.Produto'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProdutoMvcContext.Produto'  is null.");
            }
            var produto = await _context.Produto.FindAsync(id);
            if (produto != null)
            {
